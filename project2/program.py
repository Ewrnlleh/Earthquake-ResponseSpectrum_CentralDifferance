...
class Program:
    ...
    def ExcelAktar(self,listT,listValue,dosyaIsim):

        with xlsxwriter.Workbook(dosyaIsim) as workbook:
            worksheet = workbook.add_worksheet()
            
            for row_num, data in enumerate(listT):
                worksheet.write_row(row_num, 0, data)
            for row_num, data in enumerate(listValue):
    ...
    def Graph3(self):        
        wn = 2*π/self.Tn
        self.PSv = self.Sd * wn           # Pseudo Velocity Response Spectrum
        self.PSa = self.Sd * wn**2        # Pseudo Acceleration Response Spectrum 
        # Plot Graphs
        
        fig, grfk = plt.subplots(nrows=2, ncols=1)
        grfk[0].plot(self.Tn, self.PSv, color='g',label="PSv")
        grfk[0].set(ylabel='PSv [m/s]', title="pseudo velocity response spectrum")
        grfk[0].grid()
        grfk[1].plot(self.Tn, self.PSa, color='r',label="PSa")
...
dosya1.ReadData('RSN1634_MANJIL_184327.AT2')
#dosya1.Ground()
#dosya1.Graph1()
dosya1.Graph2()
dosya1.Graph3()
dosya1.ExcelAktar(dosya1.Tn, dosya1.Sd, 'dosya1Sd.xlsx')
dosya1.ExcelAktar(dosya1.Tn, dosya1.Sv, 'dosya1Sv.xlsx')
dosya1.ExcelAktar(dosya1.Tn, dosya1.Sa, 'dosya1Sa.xlsx')
dosya1.ExcelAktar(dosya1.Tn, dosya1.PSv, 'dosya1PSv.xlsx')
dosya1.ExcelAktar(dosya1.Tn, dosya1.PSa, 'dosya1PSa.xlsx')

dosya2.ReadData('RSN1634_MANJIL_184057.AT2')
#dosya2.Ground()
#dosya2.Graph1()
dosya2.Graph2()
dosya2.Graph3()
dosya2.ExcelAktar(dosya2.Tn, dosya2.Sd, 'dosya2Sd.xlsx')
dosya2.ExcelAktar(dosya2.Tn, dosya2.Sv, 'dosya2Sv.xlsx')
dosya2.ExcelAktar(dosya2.Tn, dosya2.Sa, 'dosya2Sa.xlsx')
dosya2.ExcelAktar(dosya2.Tn, dosya2.PSv, 'dosya2PSv.xlsx')
dosya2.ExcelAktar(dosya2.Tn, dosya2.PSa, 'dosya2PSa.xlsx')

dosya3.ReadData('RSN1161_KOCAELI_GBZ000.AT2')
#dosya3.Ground()
#dosya3.Graph1()
dosya3.Graph2()
dosya3.Graph3()
dosya3.ExcelAktar(dosya3.Tn, dosya3.Sd, 'dosya3Sd.xlsx')
dosya3.ExcelAktar(dosya3.Tn, dosya3.Sv, 'dosya3Sv.xlsx')
dosya3.ExcelAktar(dosya3.Tn, dosya3.Sa, 'dosya3Sa.xlsx')
dosya3.ExcelAktar(dosya3.Tn, dosya3.PSv, 'dosya3PSv.xlsx')
dosya3.ExcelAktar(dosya3.Tn, dosya3.PSa, 'dosya3PSa.xlsx')

dosya4.ReadData('RSN1161_KOCAELI_GBZ270.AT2')
#dosya4.Ground()
#dosya4.Graph1()
dosya4.Graph2()
dosya4.Graph3()
dosya4.ExcelAktar(dosya4.Tn, dosya4.Sd, 'dosya4Sd.xlsx')
dosya4.ExcelAktar(dosya4.Tn, dosya4.Sv, 'dosya4Sv.xlsx')
dosya4.ExcelAktar(dosya4.Tn, dosya4.Sa, 'dosya4Sa.xlsx')
dosya4.ExcelAktar(dosya4.Tn, dosya4.PSv, 'dosya4PSv.xlsx')
dosya4.ExcelAktar(dosya4.Tn, dosya4.PSa, 'dosya4PSa.xlsx')

Sar1 = np.sqrt(list(map(add, (i ** 2 for i in dosya1.Sa), (i ** 2 for i in dosya2.Sa)))) 

fig, gr1 = plt.subplots()
gr1.plot(dosya1.Tn,Sar1)
gr1.set(xlabel='t [s]', ylabel='Sar', title='Sar - ERZINCAN_ERZ')
gr1.grid()
plt.show()
dosya1.ExcelAktar(dosya1.Tn, Sar1, 'Sar1.xlsx')

Sar2 = np.sqrt(list(map(add, (i ** 2 for i in dosya3.Sa), (i ** 2 for i in dosya4.Sa))))

fig, gr2 = plt.subplots()
gr2.plot(dosya3.Tn,Sar2)
gr2.set(xlabel='t [s]', ylabel='Sar', title='Sar - KOBE_KAK0')
gr2.grid()
plt.show()
dosya3.ExcelAktar(dosya3.Tn, Sar2, 'Sar2.xlsx')
...
gravr.set(xlabel='t [s]', ylabel='Saravr', title='Saravr - ERZINCAN_ERZ,KOBE_KAK0')
gravr.grid()
plt.show() 
dosya1.ExcelAktar(dosya1.Tn, Saravr, 'Saravr.xlsx')
...
grsae.grid()
plt.show()
dosya1.ExcelAktar(SaeT, Sae, 'Sae.xlsx')
